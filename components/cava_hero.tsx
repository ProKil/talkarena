    ...
    <span className="whitespace-nowrap inline-flex items-center">
      ...
      {role && (
        <SuperscriptWithTooltip content={`${role}, ${affiliation}`}>
          {role === "Principal Investigator" ? "†" : role === "Task Lead" ? "‡" : role === "Project Coordinator" ? "*" : role === "Contributor" ? "§" : ""}
...
export function Hero() {
  const leaders = [
    { name: "Will Held", href: "https://williamheld.com", role: "Project Coordinator" },
    { name: "Michael Ryan", href: "https://michryan.com", role: "Project Coordinator" },
    { name: "Diyi Yang", href: "https://cs.stanford.edu/~diyiy/", role: "Principal Investigator" },
  ];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div>
          ...
          <div className="text-sm mt-6 text-center">
            ...
            <span className="inline-flex items-center mr-4">
              <SuperscriptWithTooltip content="Project Coordinator">*</SuperscriptWithTooltip>
              <span className="ml-1">Project Coordinator</span>
            </span>
            <span className="inline-flex items-center mr-4">
              <SuperscriptWithTooltip content="Task Lead">‡</SuperscriptWithTooltip>
              <span className="ml-1">Task Lead</span>
            </span>
            <span className="inline-flex items-center">
              <SuperscriptWithTooltip content="Contributor">§</SuperscriptWithTooltip>
