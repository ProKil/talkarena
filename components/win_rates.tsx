...
const ModelLabel: FC<LabelProps> = ({ name, votes, percentage }) => {
  ...
  return (
    <div
      className={`flex flex-col items-center w-full text-white ${shouldRotate ? "writing-mode-vertical" : ""}`}
    >
      <style jsx>{`
...
const TieLabel: FC<Pick<LabelProps, "votes" | "percentage">> = ({
  votes,
  percentage,
}) => {
  const shouldRotate = percentage < ROTATION_THRESHOLD;
...
const ComparisonRow: FC<ComparisonRowProps> = ({ model1, model2, tie }) => (
  <div className="w-full h-14 mb-1 last:mb-0">
    <div className="flex w-full h-full rounded-md overflow-hidden">
      ...
      {tie.votes > 0 && (
        ...
        >
          <TieLabel votes={tie.votes} percentage={tie.percentage} />
        </div>
      )}
...
const MODEL_ORDER: ReadonlyArray<ModelName> = [
  "DiVA",
  "GPT4o",
  "Gemini",
  "Qwen2",
      ...
      [
        {
          ...
          total: 500,
          winRate: 0.576,
          confidenceInterval: [0.536, 0.616],
          pValue: 0.0001,
          significant: true,
        },
        {
          ...
          total: 500,
          winRate: 0.683,
          confidenceInterval: [0.644, 0.721],
          pValue: 0,
          significant: true,
        },
        {
          ...
          total: 500,
          winRate: 0.719,
          confidenceInterval: [0.683, 0.754],
          pValue: 0,
          significant: true,
        },
        {
          ...
          total: 500,
          winRate: 0.527,
          confidenceInterval: [0.488, 0.566],
          pValue: 0.088,
          significant: false,
        },
        {
        ...
        },
        {
          ...
          total: 500,
          winRate: 0.416,
          confidenceInterval: [0.376, 0.456],
          pValue: 0,
          significant: true,
        },
        {
          ...
          total: 500,
          winRate: 0.867,
          confidenceInterval: [0.839, 0.894],
          pValue: 0,
          significant: true,
        },
        {
          ...
          total: 500,
          winRate: 0.928,
          confidenceInterval: [0.908, 0.947],
          pValue: 0,
          significant: true,
        },
        {
        ...
        },
        {
          ...
          total: 500,
          winRate: 0.765,
          confidenceInterval: [0.732, 0.797],
          pValue: 0,
          significant: true,
        },
      ] as const,
