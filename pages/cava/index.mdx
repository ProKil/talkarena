...
As long as VLLM supports your model, CAVA supports your model without any additional code. Just prefix your model path on HuggingFace with `vllm/` when running the evaluation:
...
- Ella Minzhi Li developed the speech jailbreaking task.
