...
<CAVAExample
  taskName="Spoken Task Oriented Parsing[^13] (Tan Li & Will Held)"
...
<CAVAExample 
  taskName="AMI[^14] Turn Prediction (Woody Gan)"
...
[^13]: https://facebookresearch.github.io/spoken_task_oriented_parsing/docs/semantic_parsing/

[^14]: https://groups.inf.ed.ac.uk/ami/corpus/
