...
<CAVAExample
  taskName="Pronunciation Prompt Following (Michael J. Ryan)"
...
We would like to express our gratitude to OpenAI for providing the credits that made it possible to evaluate their models. We also thank the (Stanford HAI-GCP)[https://hai.stanford.edu/research/grant-programs/google-cloud-credit-grants] compute grant for the credits used for Gemini evaluations. This research would not have been possible without their generous support.
