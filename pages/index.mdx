...
<h1 class="nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100" style={{fontSize : "2rem"}}>Judge Large Audio Models on Talk Arena!</h1>
