...
<h1 className="nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100" style={{fontSize : "2rem", fontWeight: "400"}}>Judge Large Audio Models on <span style={{fontWeight: "600"}}>Talk Arena</span>!</h1>
...
## Acknowledgements
We appreciate the computing support provided by Stanford HAI Google Cloud Credit Program and credit support provided by Google Gemini. We also would like to thank Qwen team for their help with building a model API endpoint. This platform is made possible thanks to computing support provided by SCB 10X, SCBX Group through Stanford HAI. We would also like to thank everyone who helped us test Talk Arena.
