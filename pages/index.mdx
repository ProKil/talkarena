...
## Acknowledgements
We appreciate the computing support provided by Stanford HAI Google Cloud Credit Program and credit support provided by Google Gemini. We also would like to thank Qwen team for their help with building a model API endpoint.
